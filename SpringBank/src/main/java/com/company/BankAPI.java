...
public class BankAPI {
	...
	String org_access_Token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMTExNjgxIiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNjIzMzA2NTI2LCJqdGkiOiJiZmM1Y2M4Mi05ZTFhLTQ2ZDQtYTdiMy0yODBkNzVmOTQ4ZWMifQ.usIM4IhavUeHI8AdoNOO2gYJW_bSLu05VNtNu20apoE";
	
	public Map<String, Object> getOrgAccessTokenRestTemplate() {
        String reqURL = "https://testapi.openbanking.or.kr/oauth/2.0/token";
        
        MultiValueMap<String, String> param = new LinkedMultiValueMap<String, String>(); // 파라미터
        param.add("client_id", "de1e3afe-a852-40ca-a741-5658dafd24b1");
        param.add("client_secret", "81a52f4c-3c98-4508-afbd-b54642901b3d");
        param.add("scope", "oob");
